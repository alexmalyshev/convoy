 ...
 *
 *  Asserts that <tt>tab</tt>, <tt>cmp</tt>, and <tt>hash</tt> are not
 *  <tt>NULL</tt>.
 *  Asserts that <tt>lf</tt> is non-positive.
 *
 ...
 *
 *  Asserts that <tt>tab</tt> is not <tt>NULL</tt>.
 *
 *  @param tab the address of the <tt>hasht</tt>.
 */
 ...
 *
 *  Asserts that <tt>tab</tt> and <tt>elem</tt> are not <tt>NULL</tt>
 *  If <tt>elem</tt> is already in <tt>tab</tt> then this just returns.
 *
 *  @param tab the address of the <tt>hasht</tt>.
 ...
 *
 *  Asserts <tt>tab</tt> is not <tt>NULL</tt>.
 *
 *  @param tab the address of the <tt>hasht</tt>.
 */
